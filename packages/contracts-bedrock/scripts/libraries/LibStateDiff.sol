...
library LibStateDiff {
        ...
        returns (string memory serialized_)
    {
        ...
        serialized_ = stdJson.serialize("", "accountAccesses", accountAccesses);
    }
    ...
    {
        string memory json = "";
        json = stdJson.serialize("", "chainInfo", serializeChainInfo(_accountAccess.chainInfo));
        json = stdJson.serialize("", "kind", serializeAccountAccessKind(_accountAccess.kind));
        json = stdJson.serialize("", "account", _accountAccess.account);
        json = stdJson.serialize("", "accessor", _accountAccess.accessor);
        json = stdJson.serialize("", "initialized", _accountAccess.initialized);
        json = stdJson.serialize("", "oldBalance", _accountAccess.oldBalance);
        json = stdJson.serialize("", "newBalance", _accountAccess.newBalance);
        json = stdJson.serialize("", "deployedCode", _accountAccess.deployedCode);
        json = stdJson.serialize("", "value", _accountAccess.value);
        json = stdJson.serialize("", "data", _accountAccess.data);
        json = stdJson.serialize("", "reverted", _accountAccess.reverted);
        json = stdJson.serialize("", "storageAccesses", serializeStorageAccesses(_accountAccess.storageAccesses));
        serialized_ = json;
    }
    ...
    function serializeChainInfo(VmSafe.ChainInfo memory _chainInfo) internal returns (string memory serialized_) {
        string memory json = "";
        json = stdJson.serialize("", "forkId", _chainInfo.forkId);
        json = stdJson.serialize("", "chainId", _chainInfo.chainId);
        serialized_ = json;
    }
    ...
    {
        string memory json = "";
        json = stdJson.serialize("", "account", _storageAccess.account);
        json = stdJson.serialize("", "slot", _storageAccess.slot);
        json = stdJson.serialize("", "isWrite", _storageAccess.isWrite);
        json = stdJson.serialize("", "previousValue", _storageAccess.previousValue);
        json = stdJson.serialize("", "newValue", _storageAccess.newValue);
        json = stdJson.serialize("", "reverted", _storageAccess.reverted);
        serialized_ = json;
    }
}
